export default function PrivacyPolicy() {
  return (
    <main className="max-w-4xl mx-auto mt-24 flex flex-col leading-6">
      ...
      <h3 className="text-xl font-semibold mb-1 mt-4">Interpretation</h3>
      <p>
      ...
      <h3 className="text-xl font-semibold mb-1 mt-4">Definitions</h3>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to One Click Bookmarking.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to One Click Bookmarking, accessible
            from{" "}
            <a
              href="https://www.oneclickbookmark.ing"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.oneclickbookmark.ing
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@oneclickbookmark.ing</li>
      </ul>
    </main>
  );
}
